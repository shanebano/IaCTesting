...
Modified: Added Codacy integration with GitHub Actions
"""
...
def main():
    """
    Main function to analyze IaC testing antipatterns.
    Prompts user for directory and project name, then runs analysis.
    """
